...
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0001','사장','1',NULL);
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0002','용산','2','OR0001');
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0003','SI','3','OR0002');
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0004','SM','3','OR0002');
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0005','SI1','4','OR0003');
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0006','SI2','4','OR0003');
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0007','SM1','4','OR0004');
INSERT INTO vacation.TB_ORGANIZATION (ORG_CODE,ORG_NAME,ORG_DIV,ORG_UPPER) VALUES ('OR0008','SM2','4','OR0005');
...
INSERT INTO vacation.user_authority (user_id,authority_name) VALUES 
('ID0001','ROLE_USER')
,('ID0002','ROLE_USER')
,('ID0003','ROLE_USER')
,('ID0004','ROLE_USER')
...
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VK1','VK','연차','1');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VK2','VK','반차','0.5');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VK3','VK','출산전후휴가','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VK4','VK','배우자출산휴가','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VK5','VK','경조사휴가','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VK6','VK','생리휴가','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VK7','VK','병가','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VS1','VS','대기','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VS2','VS','승인','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('VS3','VS','반려','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('1','OD','최상위','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('2','OD','본부','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('3','OD','그룹','0');
INSERT INTO vacation.TB_CODE (CODE,CODE_GROUP,CODE_NAME,CODE_VALUE) VALUES ('4','OD','팀','0');
...
INSERT INTO vacation.TB_VACATION_APPLY (reg_code,apply_emp_code,confirm_emp_code,reg_date,reg_start_date,reg_end_date,reg_num,vk_code,reg_reason,confirm_date,vs_code,reject_reason) VALUES ('VA0021','E0011','E0004',TIMESTAMP '2020-12-20 16:29:09.000000',TIMESTAMP '2020-12-08 00:00:00.000000',TIMESTAMP '2020-12-08 00:00:00.000000',1,'VK1','cv',TIMESTAMP '2020-12-20 16:34:09.000000','VS2',NULL);
INSERT INTO vacation.TB_VACATION_APPLY (reg_code,apply_emp_code,confirm_emp_code,reg_date,reg_start_date,reg_end_date,reg_num,vk_code,reg_reason,confirm_date,vs_code,reject_reason) VALUES ('VA0003','E0010','E0008',TIMESTAMP '2020-11-10 11:25:57.000000',TIMESTAMP '2020-01-15 00:00:00.000000',TIMESTAMP '2020-01-20 00:00:00.000000',NULL,'VK3','동생 결혼식 다녀오겠습니다.',NULL,'VS3','응 못가');
INSERT INTO vacation.TB_VACATION_APPLY (reg_code,apply_emp_code,confirm_emp_code,reg_date,reg_start_date,reg_end_date,reg_num,vk_code,reg_reason,confirm_date,vs_code,reject_reason) VALUES ('VA0001','E0013','E0011',TIMESTAMP '2020-11-10 13:30:06.000000',TIMESTAMP '2020-11-11 00:00:00.000000',TIMESTAMP '2020-11-13 00:00:00.000000',3,'VK3','ㅁㄴㅇㄴㅇㄻㄹㅇㄴ',TIMESTAMP '2020-11-10 13:32:14.000000','VS2',NULL);
